...
def test_db_engine() -> Iterator[Connection]:
    ...
    import src.server.activation_code.models  # noqa: F401
    import src.server.card.models  # noqa: F401
    import src.server.channel.models  # noqa: F401
    import src.server.order.models  # noqa: F401
    import src.server.proxy.models  # noqa: F401
    import src.server.sale.models  # noqa: F401
...
@pytest.fixture(scope="function")
def test_admin_token(test_client, init_test_database) -> str:
    """提供管理员 JWT token。"""
    # 登录获取 token
