...
def test_list_all_sales(test_db_session: Session):
    ...
    # 创建多个销售记录
    dao.create(user_id=1, card_name="充值卡1", quantity=1, sale_price=10.0, channel_id=1)
    dao.create(user_id=2, card_name="充值卡2", quantity=2, sale_price=20.0, channel_id=1)
...
def test_get_sales_by_user_id(test_db_session: Session):
    ...
    # 创建属于不同用户的销售记录
    dao.create(user_id=1, card_name="用户1的充值卡", quantity=1, sale_price=10.0, channel_id=1)
    dao.create(user_id=2, card_name="用户2的充值卡", quantity=1, sale_price=15.0, channel_id=1)
    dao.create(user_id=1, card_name="用户1的另一个充值卡", quantity=2, sale_price=20.0, channel_id=1)
